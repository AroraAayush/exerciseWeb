...
function ExerciseCard({exercise}) {
  return (
    <Link to={`/exercise/${exercise.id}`} className='flex flex-col justify-center items-center bg-white shadow-md border-t-4 border-orange-600 px-4 py-3 gap-y-4  hover:shadow-lg hover:border-2 hover:border-orange-600 min-w-[400px] min-h[400px] h-[400px]'>
